<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_News.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.Add_News" %>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" runat="server" enctype="multipart/form-data" data-am-validator> 
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="Textarea1" name="Des" placeholder="请输入文章内容" required></textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">
