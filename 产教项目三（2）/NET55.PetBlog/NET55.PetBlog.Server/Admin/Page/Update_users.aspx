<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_users.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.Update_users" %>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form id="Form1" class="am-form tpl-form-border-form tpl-form-border-br" runat="server" enctype="multipart/form-data" data-am-validator>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">昵称 <span class="tpl-form-line-small-title">Name</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Text1" name="uname" value="<%=umodel.UserName %>" placeholder="请输入昵称" required>
                                        <small>请填写你的昵称</small>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Text3" name="phone" maxlength="11" minlength="11" value="<%=umodel.Phone %>" placeholder="请输入号码" required>
                                        <small>请填写你的号码</small>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Text2" maxlength="18" minlength="6" value="<%=umodel.Pwd %>" name="pwd1" placeholder="请输入6-18位密码" required>
                                        <small>请填写密码</small>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Text4" value="<%=umodel.Age %>" onkeyup="value=value.replace(/[^\d]/g,'')" name="age" placeholder="只能输入数字" required>
                                        <small>请填写你的年龄</small>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <%if (umodel.Sex == "男")
                                          {
                                        %>
                                        <input type="radio" name="sex" value="男" checked="checked" required />男&nbsp;&nbsp;
                                        ...
                                        <input type="radio" name="sex" value="女" checked="checked" required />女
                                        <%
                                          } %>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="address" placeholder="输入地址" value="<%=umodel.Address %>" required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">邮箱 <span class="tpl-form-line-small-title">Eamil</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="eamil" value="<%=umodel.Eamil %>" placeholder="输入邮箱" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img id="header" src="<%=umodel.HeadImg %>" alt="">
                                            </div>
