<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_pet.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.Update_pet" %>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">添加萌宠信息</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form id="Form1" class="am-form tpl-form-border-form tpl-form-border-br" runat="server" enctype="multipart/form-data" data-am-validator>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">萌宠内容</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="title" value="<%=pmodel.Det %>" id="Text1" placeholder="请输入标题文字" required>
                                        <small>请填写标题文字10-20字左右。</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">萌宠类型</label>
                                    <div class="am-u-sm-9">
                                        <select name="type">
                                            <%foreach (var item in NET55.PetBlog.Server.Model.MyContext.Create().PetType.Where(a => true))
                                              {
                                            %>
                                            <option value="<%=pmodel.PetTypeID %>"><%=item.Type %></option>
                                            <%
                                              } %>
                                        </select>
                                    </div>
                                ...
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">萌宠图片</label>
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img src="<%=pmodel.ImgUrl %>" id="header" alt="">
                                            </div>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="hidden" name="pId" value="<%=pmodel.ID %>" />
