<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_news.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.Update_news" %>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">添加新闻</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form id="Form1" class="am-form tpl-form-border-form tpl-form-border-br" runat="server" enctype="multipart/form-data" data-am-validator>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="title" value="<%=nmodel.Title %>" id="Text1" placeholder="请输入标题文字" required>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="Textarea1" name="Des" placeholder="请输入文章内容" required><%=nmodel.Det %></textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img src="<%=nmodel.ImgUrl %>" id="header" alt="">
                                            </div>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="hidden" name="aa" value="<%=nmodel.ID %>" />
