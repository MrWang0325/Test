...
{
    public partial class PetManager : System.Web.UI.Page
    {
        public IEnumerable<PetInfo> Result;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int total = MyContext.Create().PetInfo.Count(p => true);
            PageCount = Convert.ToInt32(Math.Ceiling((double)total / PageSize));

            var db = MyContext.Create().PetInfo;
