<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsManager.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.NewsManger" %>
    ...
    <script>
        $(function () {
            ...
            $('#add_news').click(function () {
                window.location.href = "/Admin/Page/Add_News.aspx";
            })
            //修改
            $('.update').click(function () {
                var id = $(this).prev().val();
                window.location.href = "/Admin/Page/Update_news.aspx?id=" + id;
            })
            //删除
            $('.tpl-table-black-operation-del').click(function () {
                ...
                function () {
                    $.post("../Ashx/Delete_news.ashx", { id: id }, function (msg) {
                        if (msg == "ok") {
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        <li class="sidebar-nav-link">
                            <a href="/Admin/Page/NewsManager.aspx" class="sub-active">
                                <span class="am-icon-angle-right sidebar-nav-link-logo "></span>新闻信息管理
                            </a>
                        </li>

                        <li class="sidebar-nav-link">
                            <a href="/Admin/Page/ImgListManager.aspx" >
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" id="add_news" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span>新增</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="am-text-middle"><%=item.Title.Length>=10?item.Title.Substring(0,10):item.Title %></td>
                                                <td class="am-text-middle"><%=item.UserInfo.UserName %></td>
                                                <td class="am-text-middle"><%=item.CreateTime %></td>
                                                <td class="am-text-middle"><%=item.Det.Length>=100?item.Det.Substring(0,100):item.Det %></td>
