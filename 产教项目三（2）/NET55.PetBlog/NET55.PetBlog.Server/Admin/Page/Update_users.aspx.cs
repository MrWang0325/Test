    ...
    public partial class Update_users : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                //查询
                Users model = db.Users.FirstOrDefault(p => p.ID == UId);
                //修改
                model.UserName = Request["uname"];
                model.Phone = Request["phone"];
                model.Pwd = Request["pwd1"];
                model.Age = Convert.ToInt32(Request["age"]);
            ...
            else
            {
                ...
                umodel = db.Users.FirstOrDefault(u => u.ID == id);
            }
        }
    }
}