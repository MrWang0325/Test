<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_pet.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.Add_pet" %>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form id="Form1" class="am-form tpl-form-border-form tpl-form-border-br" runat="server" enctype="multipart/form-data" data-am-validator>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="title" id="Text1" placeholder="请输入标题文字" required>
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img src="../assets//img/a5.png" id="header" alt="">
                                            </div>
