<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServerManager.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.ServerManager" %>
    ...
    <script>
        $(function () {
            ...
            $('#add_server').click(function () {
                window.location.href = "/Admin/Page/Add_server.aspx";
            })

            //修改
            $('.update').click(function () {
                var id = $(this).prev().val();
                window.location.href = "/Admin/Page/Update_server.aspx?id=" + id;
            })
            //删除
            $('.tpl-table-black-operation-del').click(function () {
                ...
                function () {
                    $.post("../Ashx/Delete_server.ashx", { id: id }, function (msg) {
                        if (msg == "ok") {
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" id="add_server" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span>新增</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="am-text-middle"><%=item.BusinessTime %></td>
                                                <td class="am-text-middle"><%=item.Classify %></td>
