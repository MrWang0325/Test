<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_server.aspx.cs" Inherits="NET55.PetBlog.Server.Admin.Page.Update_server" %>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form id="Form1" class="am-form tpl-form-border-form tpl-form-border-br" runat="server" enctype="multipart/form-data" data-am-validator>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Text1" name="name" placeholder="请输入标题" value="<%=umodel.Name %>" required>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="phone" placeholder="输入联系方式" minlength="8" value="<%=umodel.Phone %>" required>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="email" name="eamil" placeholder="输入邮箱" value="<%=umodel.Eamil %>" required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">营业时间 <span class="tpl-form-line-small-title">Time</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="time" placeholder="输入营业时间" value="<%=umodel.BusinessTime %>" required>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="classify" placeholder="营业的范围" value="<%=umodel.Classify %>" required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img id="header" src="<%=umodel.ImgUrl %>" alt="">
                                            </div>
